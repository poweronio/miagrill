...
app.controller('privateCtrl', ['$http', '$scope', 'GoogleDistanceAPI', '$modal', '$log', function ($http, $scope, GoogleDistanceAPI, $modal, $log) {
    $scope.items = ['item1', 'item2', 'item3'];
    $scope.open = function (size) {
        $scope.order = {
            product: $scope.thing.name,
    ...
    $scope.products = [{
        id: 0,
        name: 'Lunch Buffet -$22.95',
        price: 22.95

    }, {
        id: 1,
        name: 'Lunchoen Table Service -$27.95',
        price: 27.95
    }, {
        id: 2,
        name: 'Dinner Buffet Style - $35.95',
        price: 35.95
    }, {
        id: 3,
        name: 'Family Style Dinner - $37.95',
        price: 37.95
    }, {
        id: 4,
        name: 'Dinner Table Service - $41.95',
        price: 41.95
    }];
